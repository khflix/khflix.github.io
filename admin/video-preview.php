...
{?>
                        ...
                        <h1 class="mt-4">Video Preview</h1>
                        <div class="card mb-4">
...
<!--                  
                                   <tr>
                                       <td colspan="3" style="text-align:center ;"><button onclick="copy()" type="submit" class="btn btn-primary btn-block" name="submit">Copy</button></td>
