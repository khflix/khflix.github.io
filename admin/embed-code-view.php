...
<textarea class="form-control" id="exampleFormControlTextarea1" rows="3" readonly><?php echo $embedcode; ?></textarea>
</div>
...
<textarea class="form-control" id="exampleFormControlTextarea2" rows="3" readonly><?php echo $result['embed_code']; ?></textarea>
</div>
